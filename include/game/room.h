/**
 * @file room.h
 * @brief Defines the Room structure and its associated functions for a 3D environment.
 *
 * This header file provides the definition of a `room` structure, which represents
 * a 3D room in a game or simulation, along with functions to initialize the room,
 * retrieve its world bounding box, get its center position, and update it based on
 * player interactions.
 */
