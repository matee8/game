/**
 * @file camera.h
 * @brief Defines the Camera structure and its associated functions for a 3D environment.
 *
 * This header file provides the definition of a `camera` structure, which represents
 * the camera in a 3D game or simulation, along with functions to initialize and
 * update the camera based on the player's perspective and room interactions.
 */
